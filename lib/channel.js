...
class Channel extends EventEmitter {
     ...
     */
    constructor(connect, { prefetchCount }) {
        super();
        let that = this;
        ...
        this.__prefetchCount = prefetchCount;
        this.EVENTS = EVENTS;
    ...
    createChannel() {
        ...
        return Promise.resolve()
                ...
                if (that.ch) {
                    ...
                    for (let event of events) {
                        ...
                        for (let listener of listeners) {
                            that.ch.removeListener(event, listener);
                        }
                    }
                }
            })
            ...
            .then(() => {
                if (this.__prefetchCount) {
                    return this.prefetch(this.__prefetchCount)
                }
            })
            .catch((error) => {
                that.status == CONNECT_STATUS.UNCONNECTED;
